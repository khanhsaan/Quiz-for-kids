...
public class CartoonActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CartoonActivity3.this, CartoonActivity4.class);
                startActivity(intent);
            }
        });


        databaseHelper = new DatabaseHelper(CartoonActivity3.this);

        // get the list of cartoons' characters from the CartoonActivity
        CartoonActivity2 cartoonActivity = new CartoonActivity2();
        ...
        if(cartoonList.get(0).equals("Bard")){
            ...
            Intent intent = new Intent(CartoonActivity3.this, CartoonActivity3.class);
        }
        ...
        choice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(choice1_text.equals(cartoonList.get(0))){
                    ...
                    Toast.makeText(CartoonActivity3.this, "Correct!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CartoonActivity3.this, CartoonActivity4.class);
                    startActivity(intent);
                } else {
                    // take the choice out of the list
                    ...
                    Toast.makeText(CartoonActivity3.this, "Incorrect.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CartoonActivity3.this, CartoonActivity4.class);
                    startActivity(intent);
                }
                // take the choice out of the list
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(CartoonActivity3.this, String.format("%d", numCorrect), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(CartoonActivity3.this, MainPage.class);
            }
        });
        ...
        animal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(CartoonActivity3.this, AnimalActivity.class);
            }
        });
        ...
        cartoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(CartoonActivity3.this, CartoonActivity.class);
            }
        });
        ...
        log_off.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CartoonActivity3.this);
                builder.setTitle("Overall score").setMessage(String.format("%s, you have overall %d points.", username, databaseHelper.getOverallScore(username))).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        redirectActivity(CartoonActivity3.this, MainActivity.class);
                    }
                });
        ...
        attempts_lo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(CartoonActivity3.this, AllAttemptsActivity.class);
            }
        });
    }
